describe PiecesJustificativesService do
  describe '.liste_documents' do
    ...
    subject do
      PiecesJustificativesService.liste_documents(Dossier.where(id: dossier.id), user_profile).map(&:first)
    end
  ...
  describe '.generate_dossier_export' do
    ...
    subject { PiecesJustificativesService.generate_dossier_export(Dossier.where(id: dossier.id), user_profile) }
