  ...
  describe 'render' do
    ...
    context 'when referentiel is properly configured' do
      ...
      it 'table' do
        ...
        # navigation
        expect(page).to have_selector("form[action=\"#{url_helpers.update_mapping_type_de_champ_admin_procedure_referentiel_path(procedure, type_de_champ.stable_id)}\"]")
      ...
      context 'when referentiel is autocomplete' do
        ...
        it 'rendrs the back to edit link' do
          expect(page).to have_link("Étape précédente", href: url_helpers.autocomplete_configuration_admin_procedure_referentiel_path(procedure, type_de_champ.stable_id))
        end
      end
      context 'when referentiel is exact match' do
        it 'renders the autocomplete configuration link' do
          expect(page).to have_link("Étape précédente", href: url_helpers.edit_admin_procedure_referentiel_path(procedure, type_de_champ.stable_id))
        end
      end
