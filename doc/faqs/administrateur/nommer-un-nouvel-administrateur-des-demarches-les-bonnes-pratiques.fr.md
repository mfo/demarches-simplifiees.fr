...
3. **Demander la suppression de votre compte** à [%{contact_email}](mailto:%{contact_email}), à condition qu’aucun dossier ou démarche ne soit rattaché à votre compte. Si nécessaire, pour votre nouvelle fonction, demandez l’ouverture d’un nouveau compte administrateur avec votre nouvel email via le formulaire  : [Demande d’inscription à %{application_name}](%{application_base_url}/demandes/new).
