...
class GroupeGestionnaire::GroupeGestionnaireListCommentaires::CommentaireComponent < GroupeGestionnaire::BaseComponent
  ...
  def created_at
    I18n.l(@commentaire.created_at.to_date, format: :short)
  end
