...
class Procedure < ApplicationRecord
  ...
  self.ignored_columns += ["api_entreprise_token_expires_at", "pro_connect_restricted", 'api_particulier_scopes', 'api_particulier_sources', 'encrypted_api_particulier_token']
