...
class TypesDeChamp::PrefillTypeDeChamp < SimpleDelegator
  ...
  def self.build(type_de_champ, revision)
    ...
    when TypeDeChamp.type_champs.fetch(:datetime)
      TypesDeChamp::PrefillDatetimeTypeDeChamp.new(type_de_champ, revision)
    when TypeDeChamp.type_champs.fetch(:integer_number)
      TypesDeChamp::PrefillIntegerNumberTypeDeChamp.new(type_de_champ, revision)
    when TypeDeChamp.type_champs.fetch(:decimal_number)
      TypesDeChamp::PrefillDecimalNumberTypeDeChamp.new(type_de_champ, revision)
