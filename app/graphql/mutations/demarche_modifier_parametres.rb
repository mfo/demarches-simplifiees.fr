...
module Mutations
  class DemarcheModifierParametres < Mutations::BaseMutation
    ...
    argument :description_target_audience, String, "La description de à qui s'adresse la démarche.", required: false
    ...
    argument :date_limite, GraphQL::Types::ISO8601Date, "La date limite de dépôt des dossiers", required: false
