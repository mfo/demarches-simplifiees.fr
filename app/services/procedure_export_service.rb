...
=======
    # TODO, refactor using user asking for the export (expert)
    # imply to store/fwd the user from the export
    attachments = ActiveStorage::DownloadableFile.create_list_from_dossiers(dossiers, @user_profile)
>>>>>>> ed52aae17 (wip)
